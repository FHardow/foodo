# Bread Order Frontend Implementation Plan
...
```bash
cd /home/florian/projects/bread-order/backend && go test ./internal/domain/order/...
```
...
```bash
cd /home/florian/projects/bread-order/backend
...
```bash
cd /home/florian/projects/bread-order/backend && go test ./...
```
...
Run: `cd /home/florian/projects/bread-order/backend && go get github.com/gin-contrib/cors`
...
```bash
cd /home/florian/projects/bread-order/backend && go build ./...
```
Expected: no errors
...
```bash
cd /home/florian/projects/bread-order
...
```bash
cd /home/florian/projects/bread-order/frontend
npm install
...
```bash
cd /home/florian/projects/bread-order/frontend && npm run dev
```
...
```bash
cd /home/florian/projects/bread-order/frontend && npm test
```
...
With backend running: `cd /home/florian/projects/bread-order/backend && make run`
